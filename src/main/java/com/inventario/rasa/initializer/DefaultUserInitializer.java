...
public class DefaultUserInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        categoriaService.eliminarCategoriaByIdLogico(2L);
        ...
        producto.setDescripcion("Lavadora");
        producto.setEstadoProducto(true);
        producto.setPeso("40kg");
        producto.setSerie("serie 1000");
        ...
        producto2.setDescripcion("Televisor OLED");
        producto2.setSerie("serie A1");
